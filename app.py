...
page_bg_img = """
<style>
/* صورة الخلفية الرئيسية من الإنترنت */
...
/* طبقة تعتيم (Overlay) عشان الكلام يبرز ويكون واضح */
[data-testid="stAppViewContainer"]::before {
    content: "";
    position: absolute;
    top: 0; left: 0; right: 0; bottom: 0;
    background-color: rgba(15, 15, 25, 0.85); /* لون كحلي غامق شفاف */
    z-index: 0;
}

/* رفع مستوى المحتوى فوق الخلفية */
[data-testid="stAppViewBlockContainer"] {
    z-index: 1;
}

/* تلوين القائمة الجانبية بلون داكن أنيق */
[data-testid="stSidebar"] {
    background-color: rgba(10, 10, 15, 0.95) !important;
    border-left: 2px solid #ff4d4d;
}

/* تجميل صندوق التقديم (شفافية زجاجية) */
...
/* تلوين النصوص باللون الأبيض عشان تتناسب مع الخلفية الغامقة */
h1, p, label, span {
...
# القائمة الجانبية البسيطة للاختيار بين الموقعين
...
# ----------------- القسم الثاني: لوحة تحكم المسؤولة -----------------
    ...
    if password == ADMIN_PASSWORD:
        ...
        st.subheader("🔍 أدوات الفرز الذكية")
